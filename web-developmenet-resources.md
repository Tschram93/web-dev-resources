...
### Animations <a name="animation"></a>

- [Animated Icons](https://icons8.com/animated-icons)
- [FlatIcon](https://flaticon.com/)

### Design Structure <a name="design-structure"></a>
...
- [CanIUse](https://caniuse.com/)
  > Checks if a feature you're looking for is available to use in browsers.
- [CSS-Tricks](https://css-tricks.com/)
- [EmailJS](https://www.emailjs.com/)
  > No server code needed. (Email submission)
- [Image Compresser](https://imagecompressor.com/)
- [TinyPNG](https://tinypng.com/)

### Hosting & Deployment<a name="deployment"></a>

- [Heoku](https://www.heroku.com/)
- [Netlify](https://www.netlify.com/)

### Stock Image Sources <a name="image"></a>
...
### Stock Video Sources<a name="video"></a>
